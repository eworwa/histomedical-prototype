...
<div class="ch-container">
    ...
    <div class="box-header well" data-original-title="">
        <h2><i class="glyphicon glyphicon-user"></i> Mis pacientes</h2>
    ...
    <div class="box col-md-12">
        <a class="btn btn-info" href="registrar-paciente.php">
    ...
    <tr>
        ...
        <th>Edad</th>
        <th>Género</th>
        <th>Estado de última consulta</th>
        <th>Acciones</th>
    </tr>
    </thead>
    <tbody>
    <tr>
        <td>David R</td>
        <td class="center">45 años</td>
        <td class="center">Mujer</td>
        <td class="center">
